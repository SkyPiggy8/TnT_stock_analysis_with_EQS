...
The agent is now ``sentiment_analyst`` and uses news/event data for its
sentiment report. It no longer fetches Reddit, StockTwits, or other forum
streams. Import from ``tradingagents.agents.analysts.sentiment_analyst``
